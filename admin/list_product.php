                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tbody-thumb">
                                            <img name="avata"width="100px" src="index.php/../../image/product/<?php echo $row['image']?>" alt="">.
                                        </div>
                                    </td>
                                    <td class="clearfix">
                                    ...
                                    <td><ul class="list-operation fl-right">
                                                  <td><a href="change_product.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                                                 <td><a href="delete_product.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                                            </ul></td>
                                </tr>
                                  <?php
                              }
