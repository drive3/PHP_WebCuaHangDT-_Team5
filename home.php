  ...
  <main class="hoc container clear"> 
    ...
    <div class="group" >
      ...
      <div class="one_half first">
        ...
        <h6 class="heading font-x2">Trang tin công nghệ hàng đầu thế giới</h6>
       
        <p>Tổng hợp tất cả các tin tức mới nhất , website uy tín số 1 Việt Nam</p>
        <footer><a href="tinmoi.php">Chi tiết &raquo;</a></footer>
        </td>
       <td>
      </div>
      <div class="one_half"><a href="#"><img style="max-width: 190%" src="image/product/s9.jpg"></a></div>
      </td>
    </div>
   </table>
...
<div class="wrapper row3">
  ...
  else
  {
    ...
    $sql_all = "select * from tbl_product limit $trang,4";
  $run_all = mysqli_query($conn,$sql_all);
?>
